...
<title>Package Details Update</title>
...
<%
	...
	<table>
		...
		<tr>
			<td>Package Name</td>
			<td><input type="text" name="packageName" value="<%= packageName %>"></td>
		</tr>
		<tr>
		<td>Event</td>
		<td><input type="text" name="eventPackageName" value="<%= eventPackageName %>"></td>
	</tr>
	<tr>
		<td>Price</td>
	...
	<tr>
		...
		<td><input type="text" name="accessPW" value="<%= accessPW %>"></td>
	</tr>
			
	</table>
	<br>
	<input type="submit" name="submit" value="Update Package Details">
	</form>
</div>
